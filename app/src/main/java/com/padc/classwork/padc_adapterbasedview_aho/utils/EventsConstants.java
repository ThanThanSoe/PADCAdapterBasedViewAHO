package com.padc.classwork.padc_adapterbasedview_aho.utils;
...
public class EventsConstants {
    ...
    public static final String EVENT_DB="event db";

    public static final String EM_EVENT_MODEL_NOT_INITIAL ="Event Model should have been initialize";
